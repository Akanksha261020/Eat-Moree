    ...
    <>
      ...
      <div className="flex flex-col w-full items-center justify-center bg-[#110705] text-white ">
        ...
        <div className="flex justify-between items-center gap-8 py-4">
          <a href="https://www.linkedin.com/in/akanksha-s-686439302/" target="_blank" >
          ...
          <a  href="https://github.com/Akanksha261020?tab=repositories" target="_blank" className="text-3xl hover:text-[#333]">
